...
export function EmployeeRegistrationForm() {
  ...
  return (
    <div className="flex items-center justify-center  bg-[#020313]">
      {loading && <Loader />}
      <Card className="text-center pt-3 pb-5 pl-5 pr-14  border" >
        <div className="flex justify-center items-center screen" >
          <img src={logo} alt="logo" width="130" height="150" className="w-35 h-20" />
        </div>
        <h3 className="flex justify-center font-roboto-mono">Employee Login</h3>
